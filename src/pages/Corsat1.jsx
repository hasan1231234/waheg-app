...
import text4 from '../images/3.png'
import text5 from '../images/2.png'
import percent from '../images/Group 1000004478.png'
export default function Corsat1() {
    return (
        <div className='d-flex flex-row-reverse'>
            ...
            <div className='right-section'>
                ...
                <div className='d-flex align-items-center gap-3'>
                <Link className="card w-100 d-flex align-items-center flex-row-reverse curser justify-content-between">
                ...
                <Link to='/cors' className="card w-100 d-flex align-items-center flex-row-reverse curser justify-content-between">
                  <div className="d-flex gap-3 float-right flex-row-reverse">
                        <img src={imgCard} alt="" width="184" height="184"/>
                        <div className='d-flex flex-column justify-content-between'>
                            <img src={textimgCard} alt="" />
